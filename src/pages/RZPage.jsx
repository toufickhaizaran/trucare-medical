...
function RZProducts() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, 'rz_products')); // your collection name
        ...
        console.error('Error fetching RZ products:', error);
      }
    };
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-6">RZ Products</h1>
